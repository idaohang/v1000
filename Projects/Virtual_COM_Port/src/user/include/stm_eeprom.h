...
#define MENU_SETTING_POWERCTROL (MENU_SETTING_LANG+1)



#define CHANGE_TMPE_VAULE_INDEX_ADDRES (MENU_SETTING_POWERCTROL+1)
...
#define CHANGE_SPEED_VAULE_SAVE_ADDRES (CHANGE_TMPE_VAULE_SAVE_ADDRES+384)
